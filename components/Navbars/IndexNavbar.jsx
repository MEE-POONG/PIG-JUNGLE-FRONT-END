    ...
    <>
      <Navbar
        className={
          navLogo == "160px"
            ? "header-area "
            : "header-area scroll " + " header-sticky"
        }
        sticky="top"
        expand="lg"
      >
        <Container>
          ...
          <Navbar.Collapse id="navbarScroll">
            <Nav className="d-flex align-items-center w-100 text-center">
              ...
              <Navbar.Brand
                href="/"
                className="logo-main d-none d-xl-block d-lg-block d-flex mx-auto w-20"
              >
                <Image
                  src={"images/logo.png"}
                  alt="logo-nav"
              ...
              <div className="d-lg-flex w-40 justify-content-center">
                ...
                <div className="d-inline-flex mx-auto">
                  ...
                  <Nav.Link
                    href="/basket"
                    className="font-menu font-bold mx-auto"
                  >
                    {cartItems.length === 0 ? (
                      <>
                      ...
                      <>
                        <span className="me-1 text-warning">{cartItems.length}</span>
                        <FaShoppingCart/>
                      </>
                    )}
                  </Nav.Link>
